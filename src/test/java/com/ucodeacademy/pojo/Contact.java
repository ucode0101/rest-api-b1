...
@Data // it adds @Getter, @Setter, @toString
...
@JsonIgnoreProperties(ignoreUnknown = true) // this will ignore any fields that I don't have in my class, but it is in response body

// This POJO class will represent/ be used for Response body
